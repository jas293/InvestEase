...
const Card = (card: any) => {
  ...
  return (
    <a className="card aticles-card" href={card.link} target='"_blank'>
      <img
        src={card.imageUrl}
        style={{ borderRadius: '0.5rem', width: '24.5rem', height: '20rem' }}
      />
      <h3>{card.title}</h3>
      <div>
        <p>{card.content}</p>
...
const NewsCard = (news: any) => {
  return (
    <a className="news-card" href={news.url} target="_blank">
...
const getDateString = (numOfDays: number | null | undefined = null) => {
  ...
  if (numOfDays) {
    currentDate = new Date(
      currentDate.getTime() - numOfDays * 24 * 60 * 60 * 1000,
    )
  }
...
export const Resources: React.FC = () => {
  ...
  const cardData: any = [
    {
      ...
      content:
        "This concise article elucidates the stock market's definition, function, and operational dynamics, making it accessible to beginners and those curious about its inner workings.",
    },
    {
      id: 2,
      ...
      content:
        'When you hear about the stock market does it feel like you’re listening to a different language? One you really want to learn but just can’t seem to grasp? You’re not alone, that’s for sure. We can help you understand what a stock market is, and how it works so the thought of investing seems less overwhelming.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content:
        'This article succinctly defines and explains key terms essential for navigating the complexities of the stock market, serving as a valuable reference for both novice and seasoned investors alike.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      content:
        'This guide provides interns with a comprehensive introduction to Exchange-Traded Funds (ETFs), covering their definition, benefits, and operational mechanisms in a concise and accessible format, empowering them to understand and potentially invest in this popular financial instrument.',
    },
    {
      id: 9,
      ...
      content:
        'Delve into the world of mutual funds with this insightful guide, offering an exploration of their structure, benefits, and investment strategies, tailored for both newcomers and seasoned investors seeking to diversify their portfolios effectively.',
    },
    {
      id: 10,
    ...
    },
    {
      ...
      content:
        'This article presents a step-by-step guide for beginner investors, outlining practical strategies and tips to construct a well-rounded investment portfolio, ensuring a solid foundation for long-term financial growth and success in the dynamic world of investing.',
    },
    {
      id: 14,
    ...
    },
    {
      ...
      content:
        'This article elucidates the critical concept of asset allocation, exploring its importance in investment planning and offering practical strategies to optimize portfolio diversification, enabling investors to navigate market fluctuations with confidence.',
    },
    {
      id: 16,
    ...
    cardData.slice(0, 14).forEach((card: any, index: number) => {
      ...
      row.push(
        <Card
          ...
          link={card.link}
          imageUrl={articleImagesPath[index % 9]}
        />,
      )
    })
  ...
  const getTopNews = () => {
    ...
    fetch(
      `https://newsapi.org/v2/everything?q=stock market&from=${fromDate}&to=${toDate}&sortBy=popularity&apiKey=001528c1abbd40de90d680eb928de0b4&domains=cnbc.com`,
      requestOptions,
    )
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <div className="main-heading-container">
          <div className="main-heading-container-extend">
            ...
            <div>
              <h4 className="resource-page-subheading">
                Collection of all good articles about investing
              </h4>
            </div>
          </div>
        </div>
        <div className="articles-container">
          <div className="articles-heading-container">
            ...
            <div>
              <h4 className="resource-page-subheading">
                Collections of informative articles to read about investements &
                stocks.
              </h4>
            </div>
          </div>
          ...
          <div className="featured-videos-container">
            <div className="featured-videos-heading-container">
              ...
              <div className="featured-videos-subheading">
                <h4 className="resource-page-subheading">
                  Explore fearured videos to learn more about stocks &
                  investemets.
                </h4>
              </div>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div className="top-stories-headline-container">
              ...
              <div className="top-stories-subheading">
                <h4 className="resource-page-subheading">
                  Find new, handpicked news you’ll love, updated daily.
                </h4>
              </div>
            </div>
