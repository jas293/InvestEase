...
const AboutUsBox = ({
  ...
  const containerClass =
    'about-us-box-item-container ' +
    (hasHover
      ? 'is-active'
      : !(hoverDivId === '' || hoverDivId === id)
      ? 'is-inactive'
      : '')
  ...
  return (
    ...
    >
      <h3 className="item_title">{heading}</h3>
      <div className="item_contents">
        <div className="item_subheading">{subHeading}</div>
...
const AboutUs: React.FC = () => {
  ...
  const box1Values: BoxType = {
    ...
    subHeading:
      'Discover Investing with Us.Begin your financial journey with a trusted companion.',
    descriptionItems: [
  ...
  const box2Values: BoxType = {
    ...
    subHeading:
      'Investment Options, Simplified. Select from strategies that match your goals and comfort level.',
    descriptionItems: [
      'Simple Beginnings: We introduce you to investing, step ¬¬by step',
      'Effortless Management: Our platform handles the complexities of the stock market.',
      'Knowledge at Your Pace: Learn the ins and outs of investing with easy-to-follow resources.',
  ...
  const box3Values: BoxType = {
    ...
    heading: 'Our Mission',
    subHeading:
      "Finance for All. We're dedicated to making the stock market approachable.",
    descriptionItems: [
    ...
    <div id="about-us-container">
      ...
      <div id="section2" className="about-us-section">
        <div id="about-us-info-container">
          ...
          <div id="info-description">
            <p>
              Welcome to InvestEase, where we transform the daunting world of
              investments into a clear path for your financial empowerment.{' '}
            </p>
            <p>
              Our dedication lies in offering straightforward investment
              solutions and educational resources tailored for those new to the
              financial landscape. Begin your journey to financial literacy and
              growth with us, effortlessly.
            </p>
          </div>
        </div>
      ...
      <div id="section3" className="about-us-section">
        <div className="referal-container">
          ...
          <div>
            <h4>Empower Others. Invite Friends, family Grow Together</h4>
          </div>
          <div style={{ marginBottom: '.5rem' }}>
            Share the ease of investing with friends and get rewarded. With
            InvestEase, every referral enriches your experience and expands our
            community of savvy investors. Let's build wealth side by side. Let's
            grow a financially savvy community together.
          </div>
          <div>
            <a
              onClick={() => {
